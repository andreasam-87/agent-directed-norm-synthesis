...
+!start : true <-  .print("hello world. I have arrived and am ready to explore but there is a queue so I have to wait");
					//!check_act.
					.

+baton_handover: true <-  .print("I have just been let in");
